...
static SLEQP_RETCODE step_rule_direct_apply(double iterate_merit,
...
static SLEQP_RETCODE step_rule_direct_free(void* step_data)
{
  StepRule* step_rule = (StepRule*) step_data;
                                            ...
                                            SleqpParams* params)
{
  SleqpStepRuleCallbacks callbacks =
    {
      .rule_apply = step_rule_direct_apply,
      .rule_reset = NULL,
