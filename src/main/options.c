...
SLEQP_RETCODE sleqp_options_create(SleqpOptions** star)
{
  ...
  *options = (SleqpOptions){0};
  ...
  options->bool_values[SLEQP_OPTION_BOOL_ALWAYS_WARM_START_LP]      = ALWAYS_WARM_START_LP_DEFAULT;
  options->bool_values[SLEQP_OPTION_BOOL_ENABLE_RESTORATION_PHASE]  = ENABLE_RESTORATION_PHASE_DEFAULT;
  options->bool_values[SLEQP_OPTION_BOOL_ENABLE_PREPROCESSOR]       = ENABLE_PREPROCESSOR_DEFAULT;
