...
#include "sleqp_types.h"
   ...
   *
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_create(SleqpSparseVec** vec,
                                                        int dim,
                                                        int nnz_max);
   ...
   *
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_create_empty(SleqpSparseVec** vec,
                                                              int dim);
   ...
   *
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_create_full(SleqpSparseVec** vec,
                                                             int dim);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_push(SleqpSparseVec* vec,
                                                      int idx,
                                                      double value);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_from_raw(SleqpSparseVec* vec,
                                                          double* values,
                                                          int dim,
                                                          double zero_eps);
   ...
   *
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_to_raw(const SleqpSparseVec* vec,
                                                        double* values);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_copy(const SleqpSparseVec* source,
   ...
   * @param[in,out] vec     A pointer to the vector
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_clear(SleqpSparseVec* vec);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_reserve(SleqpSparseVec* vec,
                                                         int nnz);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_resize(SleqpSparseVec* vec,
                                                        int dim);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_dot(const SleqpSparseVec* first,
                                                     const SleqpSparseVec* second,
                                                     double* product);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_scale(SleqpSparseVec* vector,
                                                       const double factor);
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_add(const SleqpSparseVec* first,
                                                     const SleqpSparseVec* second,
                                                     const double eps,
   ...
   * @param[out] result        A pointer to the result
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_add_scaled(const SleqpSparseVec* first,
                                                            const SleqpSparseVec* second,
  ...
  **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_clip(const SleqpSparseVec* x,
                                                      const SleqpSparseVec* lb,
                                                      const SleqpSparseVec* ub,
                                                      const double eps,
   ...
   **/
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_fprintf(const SleqpSparseVec* vec,
                                                         FILE* output);
  ...
  SLEQP_EXPORT SLEQP_RETCODE sleqp_sparse_vector_free(SleqpSparseVec** vec);
