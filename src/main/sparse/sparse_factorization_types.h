...
typedef SLEQP_RETCODE (*SLEQP_SPARSE_FACTORIZATION_SET_MATRIX)(
  void* factorization_data,
  SleqpSparseMatrix* matrix);

typedef SLEQP_RETCODE (*SLEQP_SPARSE_FACTORIZATION_SOLVE)(
  void* factorization_data,
  SleqpSparseVec* rhs);

typedef SLEQP_RETCODE (*SLEQP_SPARSE_FACTORIZATION_GET_SOL)(
  void* factorization_data,
  SleqpSparseVec* sol,
  int begin,
  int end,
...
typedef SLEQP_RETCODE (*SLEQP_SPARSE_FACTORIZATION_GET_CONDITION_ESTIMATE)(
  void* factorization_data,
  double* condition_estimate);

typedef SLEQP_RETCODE (*SLEQP_SPARSE_FACTORIZATION_FREE)(void** star);
