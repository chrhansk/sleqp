                                        ...
                                        SleqpIterate* iterate)
{
  ...
  SLEQP_CALL(aug_jac->callbacks.set_iterate(iterate,
                                            aug_jac->data));
                                              ...
                                              SleqpSparseVec* sol)
{
  ...
  SLEQP_CALL(aug_jac->callbacks.min_norm_solution(rhs,
                                                  sol,
                                                  aug_jac->data));
                                       ...
                                       SleqpSparseVec* dual_sol)
{
  ...
  SLEQP_CALL(aug_jac->callbacks.projection(rhs,
                                           primal_sol,
                                           dual_sol,
                                           aug_jac->data));
...
SLEQP_RETCODE sleqp_aug_jac_condition(SleqpAugJac* aug_jac,
                                      ...
                                      double* condition)
{
  SLEQP_CALL(aug_jac->callbacks.condition(exact,
                                          condition,
                                          aug_jac->data));
...
SLEQP_RETCODE sleqp_aug_jac_capture(SleqpAugJac* aug_jac)
{
  ++aug_jac->refcount;
...
static SLEQP_RETCODE aug_jac_free(SleqpAugJac** star)
{
  SleqpAugJac* aug_jac = *star;
