...
SLEQP_RETCODE
sleqp_tr_solver_set_time_limit(SleqpTRSolver* data, double time_limit)
{
...
SleqpTimer*
sleqp_tr_solver_get_solve_timer(SleqpTRSolver* data)
{
  return data->timer;
}
...
tr_solver_free(SleqpTRSolver** star)
{
  SleqpTRSolver* solver = *star;
